...
class Scraper
  ...
  attr_reader :file
  attr_accessor :titles, :instructions, :benefits, :yoga_hash
  ...
  def read_titles
    ...
    # @titles.each do |title| names[:title] = title end
  end
  ...
  def create_yoga_hash_lvls
    yoga_hash[:beginner] = []
    yoga_hash[:intermediate] = []
    yoga_hash[:advanced] = []
  end

  def create_beginner(titles, instructions, benefits)
    count = 0
    10.times do
      hash = Hash.new
  ...
  def create_intermediate(titles, instructions, benefits)
    count = 10
    10.times do
      hash = Hash.new
      hash[:title] = titles[count]
  ...
  def create_advanced(titles, instructions, benefits)
    count = 20
    10.times do
      hash = Hash.new
      hash[:title] = titles[count]
  ...
  def create_yoga_hash(titles, instructions, benefits)
    # binding.pry
    create_yoga_hash_lvls
    create_beginner(titles, instructions, benefits)
    create_intermediate(titles, instructions, benefits)
    create_advanced(titles, instructions, benefits)
    yoga_hash
        # titles[0..9].each do |title|
        #   instructions[0..9].each do |instruction|
        #     hash = Hash.new
        #     hash[:title] = title
      ...
      # :beginner =>
      #   titles[0..9].inject do |key, title|
      #     :key => title
      #   end
